...
const AllCategoriesCard = ({categorie}) => {
    ...
    return (
        <div className="mt-10 mb-20 mr-5 hover:border-blue-500 hover:shadow-xl relative">
            <Link to={`/home/${category}`}>
            <div className="border-[1px]  hover:border-[1px] hover:shadow-xl hover:border-blue-500  relative  card card-compact h-60  ">
