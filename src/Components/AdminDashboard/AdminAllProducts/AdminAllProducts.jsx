                            ...
                            <div className="flex">
                                <div className="border p-6 w-60 h-96 rounded-lg bg-white hover:border-orange-500 hover:shadow-xl relative">
                                    ...
                                    <div className="absolute top-2 right-2">
                                        <Link to={`/AdminDashboard/editProduct/${sale._id}`}>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-2 mt-2">
                                            ...
                                            <button onClick={() => handleRemove(sale?._id)} className="border flex py-2 px-3 text-sm font-bold rounded-md border-red-600 hover:bg-red-600 hover:shadow-xl hover:text-white">
